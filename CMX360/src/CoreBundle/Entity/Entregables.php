...
/**
 * CoreBundle\Entity\Entregables
 *
 * @ORM\Entity()
 * @ORM\Table(name="entregables")
 */
class Entregables
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="Subservicio", mappedBy="entregables")
     * @ORM\JoinColumn(name="id", referencedColumnName="idEntregable", nullable=false)
     */

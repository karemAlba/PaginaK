...
/**
 * CoreBundle\Entity\Alcances
 *
 * @ORM\Entity()
 * @ORM\Table(name="alcances")
 */
class Alcances
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="PropuestasGeneral", mappedBy="alcances")
     * @ORM\JoinColumn(name="id", referencedColumnName="idAlcance", nullable=false)
     */

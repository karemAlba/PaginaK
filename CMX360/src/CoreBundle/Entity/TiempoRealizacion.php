...
/**
 * CoreBundle\Entity\TiempoRealizacion
 *
 * @ORM\Entity()
 * @ORM\Table(name="tiempoRealizacion")
 */
class TiempoRealizacion
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\OneToMany(targetEntity="Subservicio", mappedBy="tiempoRealizacion")
     * @ORM\JoinColumn(name="id", referencedColumnName="idTiempoRealizacion", nullable=false)
     */

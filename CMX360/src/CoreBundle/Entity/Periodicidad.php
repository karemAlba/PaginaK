...
/**
 * CoreBundle\Entity\Periodicidad
 *
 * @ORM\Entity()
...
class Periodicidad
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Subservicio", mappedBy="periodicidad")
     * @ORM\JoinColumn(name="id", referencedColumnName="idPeriodicidad", nullable=false)
     */

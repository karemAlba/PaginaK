...
/**
 * CoreBundle\Entity\TipoDescuentos
 *
 * @ORM\Entity()
 * @ORM\Table(name="tipoDescuentos")
 */
class TipoDescuentos
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\OneToMany(targetEntity="PersonalGenerales", mappedBy="tipoDescuentos")
     * @ORM\JoinColumn(name="id", referencedColumnName="idTipoDescuento", nullable=false)
     */

...
/**
 * CoreBundle\Entity\PeriodoCumplimiento
 *
 * @ORM\Entity()
 * @ORM\Table(name="periodoCumplimiento")
 */
class PeriodoCumplimiento
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\OneToMany(targetEntity="Subservicio", mappedBy="periodoCumplimiento")
     * @ORM\JoinColumn(name="id", referencedColumnName="idPeriodoCumplimiento", nullable=false)
     */

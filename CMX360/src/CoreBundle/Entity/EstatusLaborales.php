...
/**
 * CoreBundle\Entity\EstatusLaborales
 *
 * @ORM\Entity()
 * @ORM\Table(name="estatusLaborales")
 */
class EstatusLaborales
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\OneToMany(targetEntity="Personales", mappedBy="estatusLaborales")
     * @ORM\JoinColumn(name="id", referencedColumnName="idEstatusLaboral", nullable=false)
     */

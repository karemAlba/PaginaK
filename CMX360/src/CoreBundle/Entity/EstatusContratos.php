...
/**
 * CoreBundle\Entity\EstatusContratos
 *
 * @ORM\Entity()
 * @ORM\Table(name="estatusContratos")
 */
class EstatusContratos
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\OneToMany(targetEntity="PersonalLaborales", mappedBy="estatusContratos")
     * @ORM\JoinColumn(name="id", referencedColumnName="idEstatusContrato", nullable=false)
     */
